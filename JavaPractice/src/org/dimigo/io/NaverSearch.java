	...
	public static void main(String[] args) {		
	    ...
	    try (InputStream is = System.in;
	        ...
	        for(int a=0; a<movieList.size(); a++) {
	        	System.out.println((a+1)+". "+movieList.get(a).getTitle()+" - "+movieList.get(a).getActors());
	        	bw.write((a+1)+". "+movieList.get(a).getTitle()+" - "+movieList.get(a).getActors()+"\n");
	        }
	        bw.flush();
